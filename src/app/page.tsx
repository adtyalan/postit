  ...
  return (
    <main className="relative min-h-screen w-full flex flex-col corkboard-bg font-body overflow-x-hidden">
      ...
      <div className="w-full flex flex-col items-center">
        {/* Hero Section */}
        <section className="w-full relative min-h-[calc(100dvh-112px)] flex flex-col items-center justify-center text-center overflow-hidden">
          ...
          <motion.div
            ...
            className="relative z-10 space-y-6 px-6 scale-[0.8] origin-center"
          >
            <h1 className="text-5xl md:text-8xl font-display font-black text-text-main tracking-tighter ink-bleed">
              THE DEAD <br />
              <span className="text-primary italic">LETTER</span> OFFICE
            </h1>
            
            <p className="max-w-2xl mx-auto text-lg md:text-xl text-text-main/80 font-newsreader italic leading-relaxed drop-shadow-sm">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center pt-8">
              <Link href="/compose">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="h-16 px-10 bg-primary text-background-paper font-display text-lg uppercase tracking-[0.2em] shadow-hard border-2 border-text-main flex items-center gap-3 group rounded-sm"
                >
              ...
              <Link href="/browse">
                <motion.button
                  whileHover={{ scale: 1.05, rotate: 1 }}
                  whileTap={{ scale: 0.95 }}
                  className="h-16 px-10 bg-background-paper text-text-main font-display text-lg uppercase tracking-[0.2em] shadow-hard border-2 border-text-main flex items-center gap-3 group rounded-sm"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5">
        ...
        <section className="w-full bg-[#1A0F0D]/40 py-24 md:py-32 flex flex-col items-center relative overflow-hidden">
          ...
          <div className="relative z-10 w-full max-w-4xl px-6">
            ...
            <motion.div
              ...
              className="relative mx-auto w-full max-w-[500px] aspect-[3/4] bg-background-paper shadow-2xl p-8 md:p-12 flex flex-col shadow-[0_20px_50px_rgba(0,0,0,0.5)]"
            >
              {/* Paper Texture */}
              ...
              <div className="relative z-10 flex flex-col h-full">
                <div className="flex justify-between items-start mb-12">
                  <div className="space-y-1">
                    ...
                    <p className="font-typewriter text-sm text-text-main">October 14, 1924</p>
                  </div>
                  <div className="w-16 h-20 border border-muted/30 flex items-center justify-center p-1 grayscale opacity-60">
                    <img src="/stamps/locomotive.png" alt="Stamp" className="w-full h-full object-cover" />
                  </div>
                </div>

                <div className="flex-1 flex flex-col space-y-6">
                  <h3 className="font-hand text-3xl text-text-main leading-none">Dearest Stranger,</h3>
                  <p className="font-newsreader text-lg md:text-xl text-text-main/90 leading-relaxed italic ink-bleed">
                ...
                <div className="mt-12 pt-8 border-t border-muted/10">
                  <p className="font-hand text-2xl text-text-main">— Anonymous</p>
                </div>
              </div>
